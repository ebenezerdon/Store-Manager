...
const createTables = () => {
  ...
  pool.query('CREATE TABLE IF NOT EXISTS sales(id serial PRIMARY KEY, productId SERIAL, productname VARCHAR(100), attendant_id INTEGER, price INTEGER, quantity INTEGER, totalprice INTEGER, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)');
